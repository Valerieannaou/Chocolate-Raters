class Chocolate < ActiveRecord::Base
  attr_accessible :description, :name, :photos_attributes , :image ,:type_of_chocolate, :cocoa, :chocolatier_id ,:beans,:bar_type,:bar_state, :flavour
  ...
  after_save ThinkingSphinx::RealTime.callback_for(:chocolate)
  validates :name ,:chocolatier_id, presence: true
